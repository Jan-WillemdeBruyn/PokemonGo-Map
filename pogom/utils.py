...
def get_args():
    ...
    parser.add_argument('-D', '--db', help='Database filename', default='pogom')
    parser.add_argument('-Du', '--dbuser', help='Database user', default='root')
    parser.add_argument('-Dp', '--dbpassword', help='Database password', default='')
    parser.add_argument('-Dh', '--dbhost', help='Database host', default='localhost')
